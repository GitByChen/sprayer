...
#define W25Qx_Enable() 			HAL_GPIO_WritePin(FLASH_SPI_GPIO, FLASH_SPI_CS_PIN, GPIO_PIN_RESET)
#define W25Qx_Disable() 		HAL_GPIO_WritePin(FLASH_SPI_GPIO, FLASH_SPI_CS_PIN, GPIO_PIN_SET)
...
#define HX711_WEIGHT_DATA_FLASH_BASE    CJSON_DATA_SIZE+100          //去皮值存放地址
#define HX711_WEIGHT_DATA_SIZE          sizeof(HX711_Massage.Base_Weight_Value)  //值占用内存大小

#define BindFlag_DATA_FLASH_BASE    HX711_WEIGHT_DATA_FLASH_BASE+10           //去皮值存放地址
